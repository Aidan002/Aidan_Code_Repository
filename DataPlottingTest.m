...
hold on
%errorbar(tan(Angle), DivergenceHalfAngle.^3, AngleU, 'horizontal', 's', 'Color', 'Magenta')
%errorbar(tan(Angle), DivergenceHalfAngle.^3, DivergenceHalfAngleU, 's', 'Color', 'Magenta')
plot(deg2rad(tan(Angle)), DivergenceHalfAngle.^3,'marker','square', 'MarkerFaceColor', 'black', 'linestyle','none')
...
xlabel('Shearing Interferometer Fringe Angle tan(rad)')
ylabel('Divergence Half-Angle Cubed (mrad)')
...
nexttile;
hold on
errorbar(x_prime_1, DivergenceHalfAngle, nthroot(AngleU, 3), 'horizontal', 's', 'Color', 'Magenta')
errorbar(x_prime_1, DivergenceHalfAngle, nthroot(DivergenceHalfAngleU, 3), 's', 'Color', 'Magenta')
...
nexttile;
hold on
errorbar(x_prime_2, DivergenceHalfAngle(1:7), nthroot(AngleU, 3), 'horizontal', 's', 'Color', 'Magenta')
errorbar(x_prime_2, DivergenceHalfAngle(1:7), nthroot(DivergenceHalfAngleU(1:7), 3), 's', 'Color', 'Magenta')
...
grid on
box on
title('Cube Root Regression Excluding Outliers')
xlabel('Shearing Interferometer Fringe Angle (°)')
ylabel('Divergence Half-Angle (mrad)')
xline(0, 'Color', '#808080')
yline(0, 'Color', '#808080')
